...
void runAuto()
{
	...
	else
	{
		switch (gCurAuto)
		{
			case 0: /* Dumb block */ autoTest(); break;
			case 1: /* 20 - autoloader */ autoTest(); break;
			case 2: /* 20 - audience */ autoTest(); break;
			case 3: /* 5 - autoloader */ autoTest(); break;
			case 4: /* 5 - audience */ autoTest(); break;
			case 5: /* 1s + block - autoloader */ autoTest(); break;
			case 6: /* 1s + block - audience */ autoTest(); break;
			case 7: /* 1s + BOOM KAPOW - autoloader */ autoTest(); break;
			case 8: /* 2s + block - audience */ autoTest(); break;
			case 9: /* Side block - autoloader */ autoTest(); break;
			case 10: /* Side block - audience */ autoTest(); break;
		}
	}
#elif SKILLS_ROUTE < 0
	autoTest();
